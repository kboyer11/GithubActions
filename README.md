[![Run App Boyer, Kaden](https://github.com/kboyer11/GithubActions/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/kboyer11/GithubActions/actions/workflows/ci.yml)
